...
const { getActivityLabelFromEvent, getDateAndTeamMemberFromEvent, getActivityLabelFromCreatedDog, getActivityLabelFromAuditFieldRecord, fieldHasBeenUpdated } = require('./field-mapping')
...
const mapAuditedChangeEventToCheckActivityRows = (event) => {
  ...
  return auditedFieldRecords.reduce((activityRows, changeRecord) => {
    ...
    if (fieldHasBeenUpdated(changeRecord) && activityLabel !== 'N/A') {
