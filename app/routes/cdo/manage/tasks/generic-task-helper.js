...
const taskList = [
  ...
  { name: tasks.applicationPackEmailed, Model: ViewModelEmailApplicationPack, validation: validateSendApplicationPack, key: 'email-application-pack', label: 'Send application pack', apiKey: 'emailApplicationPack', stateKey: 'applicationPackEmailed' },
  { name: tasks.applicationPackPosted, Model: ViewModelPostApplicationPack, validation: validateSendApplicationPack, key: 'post-application-pack', label: 'Send application pack', apiKey: 'postApplicationPack', stateKey: 'applicationPackPosted' },
...
const getTaskData = async (dogIndex, taskName, user, request, payload = {}) => {
  ...
  } else if (taskName === 'send-application-pack') {
