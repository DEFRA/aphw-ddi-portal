...
const taskList = [
  ...
  { name: tasks.microchipNumberRecorded, Model: ViewModelRecordMicrochipNumber, validation: validateMicrochipNumber, key: 'record-microchip-number', label: 'Record microchip number', apiKey: 'microchipNumber', stateKey: 'microchipNumberRecorded' },
