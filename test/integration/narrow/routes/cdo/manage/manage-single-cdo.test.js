...
describe('Manage Cdo test', () => {
  ...
  test('GET /cdo/manage/cdo/ED123 route returns 200 with completed tasks overriding "Cannot start yet"', async () => {
    ...
    expect(document.querySelectorAll('ul.govuk-task-list li div')[3].textContent.trim()).toBe('Completed')
    ...
    expect(document.querySelectorAll('ul.govuk-task-list li div')[7].textContent.trim()).toBe('Completed')
    expect(document.querySelectorAll('ul.govuk-task-list li div')[8].textContent.trim()).toBe('Send Form 2')
    expect(document.querySelectorAll('ul.govuk-task-list li div')[9].textContent.trim()).toBe('Completed')
    ...
    expect(document.querySelectorAll('ul.govuk-task-list li div')[11].textContent.trim()).toBe('Completed')
  })
