...
describe('Manage Cdo test', () => {
  ...
  test('GET /cdo/manage/cdo/ED123 route returns 200 with completed tasks overriding "Cannot start yet"', async () => {
    ...
    expect(document.querySelectorAll('ul.govuk-task-list li div')[3].textContent.trim()).toBe('Completed on 01 February 2024')
    expect(document.querySelectorAll('ul.govuk-task-list li div')[4].textContent.trim()).toBe('Record microchip number')
    expect(document.querySelectorAll('ul.govuk-task-list li div')[5].textContent.trim()).toBe('Completed on 03 March 2024')
    expect(document.querySelectorAll('ul.govuk-task-list li div')[6].textContent.trim()).toBe('Record application fee payment')
    expect(document.querySelectorAll('ul.govuk-task-list li div')[7].textContent.trim()).toBe('Completed on 02 March 2024')
    expect(document.querySelectorAll('ul.govuk-task-list li div')[8].textContent.trim()).toBe('Send Form 2')
    expect(document.querySelectorAll('ul.govuk-task-list li div')[9].textContent.trim()).toBe('Completed on 03 April 2024')
    ...
    expect(document.querySelectorAll('ul.govuk-task-list li div')[11].textContent.trim()).toBe('Completed on 10 April 2024')
  })
