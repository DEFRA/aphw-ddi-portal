...
describe('View regular jobs', () => {
  ...
  test('GET /admin/regular-jobs route returns 200', async () => {
    ...
    expect(rows[0].querySelectorAll('.govuk-table__cell')[1].textContent.trim()).stringContaining('Sat Feb 03 2024 11:00:00')
    expect(rows[0].querySelectorAll('.govuk-table__cell')[2].textContent.trim()).stringContaining('Sat Feb 03 2024 11:30:00')
    ...
    expect(rows[1].querySelectorAll('.govuk-table__cell')[1].textContent.trim()).stringContaining('Fri Feb 02 2024 11:00:00')
    expect(rows[1].querySelectorAll('.govuk-table__cell')[2].textContent.trim()).stringContaining('Fri Feb 02 2024 11:30:00')
    ...
    expect(rows[2].querySelectorAll('.govuk-table__cell')[1].textContent.trim()).stringContaining('Thu Feb 01 2024 11:00:00')
    expect(rows[2].querySelectorAll('.govuk-table__cell')[2].textContent.trim()).stringContaining('Thu Feb 01 2024 11:30:00')
