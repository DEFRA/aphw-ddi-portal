...
describe('Insurance', () => {
  ...
  const { getCompanies, addInsuranceCompany, removeInsuranceCompany } = require('../../../../../app/api/ddi-index-api/insurance')
  ...
  test('GET /admin/insurance route returns 200', async () => {
    ...
    expect(pageContent).toContain('Existing records are unchanged.')
  ...
  test('POST /admin/insurance route returns 200 given team member is removed', async () => {
    const payload = {
      remove: '2'
    }
