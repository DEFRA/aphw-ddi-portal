...
describe('Delete dogs 2', () => {
  ...
  describe('GET /admin/delete/dogs-confirm route', () => {
    test('returns 200', async () => {
      ...
      expect(document.querySelectorAll('form .govuk-body')[1].textContent.trim()).toBe('You can raise a support ticket in the next 90 days if you need to recover a deleted dog record.')
    })
